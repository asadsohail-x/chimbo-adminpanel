    ...
    >
      ...
      <DialogContent dividers>
        ...
        <Box sx={rowStyles}>
          ...
          <Box sx={valueStyles}>
            <TextField color="secondary" sx={{}} placeholder="Min" />
          </Box>
        </Box>
        <Box sx={rowStyles}>
          <Box sx={labelStyles}>Max</Box>
          <Box sx={valueStyles}>
            <TextField color="secondary" sx={{}} placeholder="Max" />
          </Box>
        </Box>
        ...
        <Box sx={rowStyles}>
          ...
          <Box sx={valueStyles}>
            <TextField color="secondary" sx={{}} placeholder="City" />
          </Box>
        </Box>
        <Box sx={rowStyles}>
          <Box sx={labelStyles}>State</Box>
          <Box sx={valueStyles}>
            <TextField color="secondary" sx={{}} placeholder="State" />
          </Box>
        </Box>
